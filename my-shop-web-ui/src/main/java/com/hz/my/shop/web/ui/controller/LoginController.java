...
import com.hz.my.shop.commons.utils.EmailSendUtils;
import com.hz.my.shop.web.ui.api.UsersApi;
...
public class LoginController {
    ...
    public String login(TbUser tbUser,Model model,HttpServletRequest request) throws Exception {
        ...
        //登录成功
            ...
            //emailSendUtils.send("用户登录",String.format("用户 【%s】 登录 MyShop", user.getUsername()), user.getEmail());
            //将会员信息放入session会话中
